...
if(isset($_POST['submit'])){
   ...
   $address = $_POST['houseno'] .', '.$_POST['area'].', '.$_POST['city'] .', '. $_POST['state'] .', '. $_POST['country'] .' - '. $_POST['pin_code'].','.$_POST['landmark'];
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>your address</h3>
      <input type="text" class="box" placeholder="houseno" required maxlength="50" name="houseno">
      ...
      <input type="text" class="box" placeholder="country name" required maxlength="50" name="country">
       <input type="text" class="box" placeholder="landmark(optional)" required maxlength="50" name="landmark">
